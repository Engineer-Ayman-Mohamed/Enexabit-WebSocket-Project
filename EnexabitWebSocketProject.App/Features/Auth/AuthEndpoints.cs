...
public static class AuthEndpoints
{
    public static RouteGroupBuilder MapAuthEndpoints(this RouteGroupBuilder group)
    {
        ...
        group.MapPost("/login", async (LoginRequest req, AuthService auth, TokenService token, HttpContext ctx) =>
        {
        ...
        group.MapPost("/refresh", async (HttpContext ctx, TokenService token) =>
        {
            var clientType = ctx.Request.Headers["X-Client-Type"].FirstOrDefault() ?? "web";
        ...
        group.MapPost("/logout", async (HttpContext ctx, TokenService token, AppDbContext db) =>
        {
