...
- [Live URL and Test Credentials](#live-url-and-test-credentials)
...
| CI/CD | GitHub Actions to WebDeploy |
...
|--------|------|:---:|------------|
| POST | `/api/auth/register` | No | Create account (username, password, displayName) |
| POST | `/api/auth/login` | No | Returns JWT + refresh token (cookie for web, body for mobile) |
| POST | `/api/auth/refresh` | No | Rotates refresh token (from cookie / X-Refresh-Token header / body) |
...
| GET | `/swagger` | No | Interactive API documentation |
...
### Phase 7 - Mobile and Cross-Platform Support
...
## Live URL and Test Credentials

**Live API:** [https://enexabitwebsocket.runasp.net](https://enexabitwebsocket.runasp.net)

**Flutter Web App:** [https://enexabitwebsocket.runasp.net/flutterApp/](https://enexabitwebsocket.runasp.net/flutterApp/)

**React Web App:** [https://channel-chat-two.vercel.app](https://channel-chat-two.vercel.app)
...
| File | Description |
|------|-------------|
| `documentation/MOBILE_CLIENT_SUPPORT.md` | Dual-mode token delivery architecture and header conventions |
| `documentation/mobile/CODE_IMPLEMENTATION.md` | Flutter/Dart SignalR client implementation with `signalr_netcore` |
